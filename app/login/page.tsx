    ...
    <div className="min-h-screen bg-blue-100 flex items-center justify-center p-4">
      <Card className="w-full max-w-lg py-8">
        <CardHeader className="text-center ">
            <Image src="/Vector.svg" alt="logo" width={100} height={100} className="size-6 mx-auto mb-5" />
          <CardTitle className="text-2xl font-bold">Water Saving Calculator</CardTitle>
          <p className="text-gray-600 mt-2">Login to track your water consumption</p>
        </CardHeader>
        <CardContent>
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-5 mt-5">
              ...
              <div className="flex items-center justify-between">
                ...
                />
                <Link href="/forgot-password" className="text-sm text-[#646D78] hover:underline">
                  Forgot password?
                </Link>
              </div>
