...
import { Car, Droplet, ShowerHeadIcon as Shower, Sprout, Timer, WashingMachine } from "lucide-react"
      ...
      <main>
        ...
        <section className="bg-sky-200 px-6 py-20">
          <div className="max-w-7xl mx-auto">
            ...
            <p className="text-gray-600 max-w-2xl">
              Discover practical ways to reduce your water consumption and make a positive impact on the environment
              while saving money.
            </p>
          </div>
        </section>
        ...
        <section className="bg-gray-100 px-6 py-20">
          <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-6">
            {tips.map((tip) => (
              <div key={tip.title} className="bg-white rounded-lg p-6 hover:shadow-lg transition-shadow">
        ...
        <section className="bg-sky-200 px-6 py-20 text-center">
          <h2 className="text-3xl font-bold mb-4">Calculate Your Water Savings</h2>
          <p className="text-gray-600 mb-8 max-w-2xl mx-auto">
            Use our calculator to see how much water and money you could save by implementing these tips.
          </p>
